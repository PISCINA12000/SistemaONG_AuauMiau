...
public class Conexao 
{
    ...
    public boolean gravarImagem(File file, String tabela, String colunaFoto, String colunaId,int id)
    {
        try{


        String sql = "UPDATE " + tabela + " SET "+ colunaFoto + "=? WHERE " + colunaId + "=" + id;
    ...
    public BufferedImage carregarImagem(String tabela, String colunaFoto, String colunaId,int id){
        BufferedImage bufferedImage = null;
       try {
           String sql = "SELECT " + colunaFoto + " FROM " + tabela + " WHERE " + colunaId + "=" + id;
           Statement statement = connect.createStatement();
